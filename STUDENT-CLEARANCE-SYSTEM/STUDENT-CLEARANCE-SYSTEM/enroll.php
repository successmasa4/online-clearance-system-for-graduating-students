...
if($ret)
{
$_SESSION['msg']="Clearance Successfull wait for admin response !! Check in your account for clearance notification by Admin ";
header("Location: studentform1.php");
}
else
{
  $_SESSION['msg']="Error : Not Cleared";
}
}
?>
...
<head>
    ...
    <title>Clearance Enrollment</title>
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Clearance verification </h1>
                    </div>
                </div>
                <div class="row" >
...
<div class="form-group">
    <label for="Pincode">Verification Code  </label>
...
<?php } ?>
 ...
 <button type="submit" name="submit" id="submit" class="btn btn-danger">Clear</button>
</form>
                            </div>
                            </div>
                    </div>
