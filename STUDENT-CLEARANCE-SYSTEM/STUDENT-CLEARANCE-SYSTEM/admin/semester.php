 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Month  </h1>
                    </div>
                </div>
                <div class="row" >
...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
   ...
   <div class="form-group">
    <label for="semester">Add Month  </label>
    <input type="text" class="form-control" id="semester" name="semester" placeholder="month" required />
  </div>
