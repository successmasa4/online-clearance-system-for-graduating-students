...
<?php if($_SESSION['login']!="")
{
 ...
 ?>
         <div class="col-lg-6 col-md-6 col-sm-6">
          <p class="text-muted">If you got any issues or You have not been cleared by the admin. <a href="contactus.html">CLICK HERE</a> to contact admin</p>
        </div>
     </div>
    </div>
...
<div class="form-group">
    <label for="Verification code">Verificationcode  </label>
